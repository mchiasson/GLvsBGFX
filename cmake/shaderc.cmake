...
function(shaderc _SHADER_TITLE)
    ...
    if(WIN32)
        add_custom_command(
            OUTPUT ${_SHADERC_OUTPUT}/dx9/${_SHADERC_INPUT_NAME_WE}.bin
            COMMAND bkaradzic::shaderc -f ${_SHADERC_INPUT} -i ${_SHADERC_INPUT_DIRECTORY} -i ${bgfx_DIR}/../../../include/bgfx -o ${_SHADERC_OUTPUT}/dx9/${_SHADERC_INPUT_NAME_WE}.bin --type ${_SHADERC_TYPE} --platform windows -p $<IF:$<STREQUAL:_SHADERC_TYPE,"v">,v,p>s_3_0 -O 3
        ...
        list(APPEND ${_SHADER_TITLE}
            ${_SHADERC_OUTPUT}/dx9/${_SHADERC_INPUT_NAME_WE}.bin
            ${_SHADERC_OUTPUT}/dx11/${_SHADERC_INPUT_NAME_WE}.bin
        )
    endif()
